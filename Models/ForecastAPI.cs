...
//    using Models;
//
//    var forecastApi = ForecastApi.FromJson(jsonString);
...
namespace Models
{
    ...
    public partial class ForecastApi
    {
    ...
    public partial class ForecastApi
    {
        public static ForecastApi FromJson(string json) => JsonConvert.DeserializeObject<ForecastApi>(json, Models.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ForecastApi self) => JsonConvert.SerializeObject(self, Models.Converter.Settings);
    }
