...
//    using Business;
//
//    var weatherUrlApi = WeatherUrlApi.FromJson(jsonString);
...
namespace Business
{
    ...
    public partial class WeatherUrlApi
    {
        ...
        public WeatherUrlApiProperties Properties { get; set; }
    }
    ...
    public partial class WeatherUrlApiProperties
    {
        [JsonProperty("@id")]
        public Uri Id { get; set; }
    ...
    public partial class WeatherUrlApi
    {
        public static WeatherUrlApi FromJson(string json) => JsonConvert.DeserializeObject<WeatherUrlApi>(json, Business.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this WeatherUrlApi self) => JsonConvert.SerializeObject(self, Business.Converter.Settings);
    }
